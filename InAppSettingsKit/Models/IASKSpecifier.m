...
- (NSString*)timeFormat {
    return [_specifierDict objectForKey:kIASKTimeFormat];
}
...
- (UIImage *)cellImage
{
    NSString *imageName = _specifierDict[kIASKCellImage];
...
{
    NSString *imageName = _specifierDict[kIASKCellImage];
    return imageName ? [UIImage imageNamed:[imageName stringByAppendingString:@"Highlighted"]] : nil;
}
